...
class ScrapeOpsBrowserHeaders:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_browser_headers_active = settings.get("SCRAPEOPS_BROWSER_HEADERS_ENABLED", False)
    ...
    def process_request(self, request, spider):
        if self.browser_headers_list:
            random_browser_headers = choice(self.browser_headers_list)
            request.headers.update(random_browser_headers)
            # print("************************ NEW HEADERS ****************************")
...
#     def __init__(self, settings):
#         self.api_key = settings.get("PROXY_API_KEY")
